              ...
              <div class="row al_center">
                <div class="col-lg-3 col-12 tc tl_lg col-md-12 dn_false_1024">
                  <div class="nt-social">
                    <a target="_blank" href="https://www.facebook.com/#"
                      ...
                      <span class="tt_txt">Ikuti di Facebook</span><i class="facl facl-facebook"></i>
                    </a>
                    <a target="_blank" href="https://twitter.com/#"
                      class="twitter cb ttip_nt tooltip_bottom_right">
                      <span class="tt_txt">Ikuti di Twitter</span><i class="facl facl-twitter"></i>
                    </a>
                    <a target="_blank" href="https://www.instagram.com/#/"
                      class="instagram cb ttip_nt tooltip_bottom_right">
                      <span class="tt_txt">Ikuti di Instagram</span><i class="facl facl-instagram"></i>
                    </a>
                    <a target="_blank" href="https://www.linkedin.com/in/#"
                      class="linkedin cb ttip_nt tooltip_bottom_right">
                      <span class="tt_txt">Ikuti di Linkedin</span><i class="facl facl-linkedin"></i>
                    </a>
                  </div>
                </div>
                ...
                <div class="col-lg-6 col-12 tc col-md-12 dn_false_1024">
                    @if (session()->get('language') === 'indonesia')
                      <div class="header-text">Diskon penjualan musim panas
                        <span class="cr fwm">20%</span> gunakan kode “SUMMER20”!
                        <a href="{{ route('categoryproductsbn', $category->category_slug_bn) }}"><span class="cr fwm">Beli Sekarang</span> </a>
                      </div>
                  @else
                  <div class="header-text">Diskon penjualan musim panas
                    <span class="cr fwm">20%</span> gunakan kode “SUMMER20”!
                    <a href="{{ route('categoryproductsen', $category->category_slug_en) }}"><span class="cr fwm">Beli Sekarang</span> </a>
                  </div>
                  @endif
                ...
                <div class="col-lg-3 col-12 tc col-md-12 tr_lg dn_false_1024">
                  <div class="nt_currency pr cg currencies sp_currencies wsn dib cur_stt_0">
                    @if (session()->get('language') === 'bangla')
                      <span class="active text-danger">Bahasa</span><i
                    ...
                    <ul class="pa pe_none ts__03 bgbl ul_none tl op__0 z_100 r__0 pt__15 pb__15 pr__15 pl__15">
                      ...
                      <li><a class=" cg db text-dark-blue"
                          href="{{ route('language.bangla') }}">Indonesia</a></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="row no-gutters al_center">
                  <div class="col-auto ha8_cat">
                    <h5 class="mg__0 fs__14 flex al_center">
                      <i class="las la-bars mr__5 fs__18"></i><span class="dib truncate">Semua kategori</span>
                    </h5>
                    ...
                    <nav class="nt_navigation tl hover_side_up nav_arrow_false">
                      <ul id="nt_menu_id"
                        ...
                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                          <a class="lh__1 flex al_center pr"
                            href="{{ route('frontend.home') }}">Rumah</a>
                        </li>
                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">

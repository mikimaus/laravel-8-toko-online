          ...
          <div class="gecko-scroll-content-quick">
            <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
                    ...
                    <div class="variations_button in_flex column w__100 buy_qv_false">
                      <div class="flex wrap">
                        ...
                        <button type="submit" data-time='6000' data-ani='shake' class="single_add_to_cart_button button truncate js_frm_cart w__100 mt__20 order-4"  onclick="addToCart()">
                          <span class="txt_add ">Tambahkan ke keranjang</span>
                        </button>
                        @else
                        <button type="submit" data-time='6000' data-ani='shake' class="single_add_to_cart_button button truncate js_frm_cart w__100 mt__20 order-4" onclick="addToCart()">
              ...
              <div class="product_meta">
                ...
                @if (session()->get('language')==='bangla')
                <span class="posted_in"><span class="cb">Kategori:</span> <a href="" class="cg" id="category_name_bn"></a>
                </span>
                @else
              ...
              <div class="social-share tc">
                <div class="at-share-btn-elements kalles-social-media d-block text-left fs__0 lh__1">
                  <a target="_blank" href="https://www.facebook.com/#" class="at-icon-wrapper at-share-btn at-svc-facebook bg-white kalles-social-media__btn">
                  ...
                  <a target="_blank" href="https://twitter.com/#" class="at-icon-wrapper at-share-btn at-svc-twitter bg-white kalles-social-media__btn">
                  ...
                  <a target="_blank" href="https://www.messenger.com/#" class="at-icon-wrapper at-share-btn at-svc-messenger bg-white kalles-social-media__btn">

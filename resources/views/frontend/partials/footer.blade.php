                  ...
                  <div class="footer-contact">
                    <p>
                      <a class="d-block" href="index.html">
                        <img class="w__100 mb__15 lazyload max-width__95px" src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20220%2066%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" alt="E-Commerce" data-src="/{{setting('site_logo')}}">
                      </a>
                    </p>
                    <p>
                      <i class="pegk pe-7s-map-marker"> </i><span>Riau  <br>
                        <span class="pl__30">Indonesia</span></span>
                    </p>
                    <p><i class="pegk pe-7s-mail"></i>
                      <span><a href="https://themes.the4.co/cdn-cgi/l/email-protection#56353938223735221635393b2637382f7835393b"><span class="__cf_email__" data-cfemail="2e4d41405a4f4d5a6e4d41435e4f4057004d4143">@gmail.com</span></a></span>
                    </p>
                    <p><i class="pegk pe-7s-call"></i> <span>+62312733791 </span></p>
                    <div class="nt-social">
            ...
            <div class="col-lg-2 col-md-6 col-12 mb__50 order-lg-2 order-1">
              <div class="widget widget_nav_menu">
                <h3 class="widget-title fwsb flex al_center fl_between fs__16 mg__0 mb__30">
                  <span class="txt_title">  {{ (session()->get('language') === 'bangla') ? 'Kategori' : 'Categories'}} </span>
                  <span class="nav_link_icon ml__5"></span>
                </h3>
